...
<?= section_toolbar('Notre histoire', '', $editHistoireUrl ? '<a class="icon-btn" title="Modifier" href="' . h($editHistoireUrl) . '">✎</a>' : '') ?>
...
<?php if (!$groups): ?>
  <?= empty_state('🙏', 'Aucun membre de l\'équipe pour le moment.') ?>
<?php else: ?>
