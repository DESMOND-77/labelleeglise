...
/**
 * Compatibilité — page Paramètres (comptes + accès responsables).
 * Portage de l'ancien pages_parametres.php.
 */
...
{
    $candidates = Query::all("SELECT id, prenom, nom FROM users WHERE role IN ('responsable','leader','pasteur','reverant') ORDER BY prenom, nom");
